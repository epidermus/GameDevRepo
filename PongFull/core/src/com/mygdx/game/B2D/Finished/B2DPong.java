...
public class B2DPong extends ApplicationAdapter {
    ...
    public void create() {
        ...
        leftPaddle = new B2DPaddle(world, "left paddle", paddleSize, Color.GOLDENROD);
        rightPaddle = new B2DPaddle(world, "right paddle", paddleSize, Color.TEAL);
        ...
        ball = new B2DBall(world, "ball", ballSize, Color.WHITE);
