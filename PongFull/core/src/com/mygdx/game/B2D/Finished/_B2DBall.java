...
public class _B2DBall extends B2DPongBody implements _B2DCollisionHandler {

    float speed = 10f;

    public _B2DBall(World _world, String _name, Vector2 _size, Color _color) {
